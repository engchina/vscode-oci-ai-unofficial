    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          {subtitle && <div className={clsx("mt-1 truncate text-[10px]", mutedClassName)}>{subtitle}</div>}
          {details.length > 0 && (
            <div className={clsx("mt-2 flex flex-wrap gap-x-3 gap-y-1 text-[10px]", mutedClassName)}>
              {details.map((detail) => (
